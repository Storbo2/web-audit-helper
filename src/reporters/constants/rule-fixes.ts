export const RULE_FIXES: Record<string, string> = {
    ...
    "SEC-03": "Replace embedded http:// resources with https:// URLs to avoid mixed content on secure pages.",
    ...
    "QLT-03": "Remove or merge adjacent duplicate controls unless they intentionally serve distinct interaction contexts.",
